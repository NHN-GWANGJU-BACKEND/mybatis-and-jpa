...
public class ReplyController {
    ...
    public String replyRegister(@RequestParam String content,
        ...
        int replyInsert = replyService.insertReply(new ReplyVo(loginId, articleId, content));
        int updateReplyCount = articleService.updateReplyCountPlus(articleId);

        if (replyInsert != 1 || updateReplyCount != 1) {
